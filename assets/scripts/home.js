async function displaySpotify() {
  let album1 = await fetch("https://striveschool-api.herokuapp.com/api/deezer/album/274652342");
  ...
  let album3 = await fetch("https://striveschool-api.herokuapp.com/api/deezer/album/9884518");
  ...
  document.querySelector(".card-row-album").innerHTML = `<div class="card">
    ...
    <div class="card-titles"> 
        <a href="http://localhost:5501/album.html?id=274652342"> <h3>${albumObjects.title}</h3> </a>
  ...
  <div class="card">
    ...
    <div class="card-titles">
        <a href="http://localhost:5501/album.html?id=9884518"> <h3>${album3Objects.title}</h3> </a>
        <a href="http://localhost:5501/artist.html?id=1037707"> <p>${album3Objects.contributors[0].name}</p> </a>
    </div>
  </div>
